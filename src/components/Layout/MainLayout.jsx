...
const navigation = [
  ...
  { name: "Мои Заявки", href: "/ticket", icon: CollectionIcon, current: false },
  { name: "Тикеты", href: "/ticket", icon: InboxIcon, current: false },
            ...
            <div className="flex-1 flex justify-between px-4 md:px-0">
              ...
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <Menu as="div" className="ml-3 relative">
                  <div>
                    <Menu.Button className="max-w-xs flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-700">
