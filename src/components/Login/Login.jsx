...
import logo from '../Login/sd_logo.png';
  ...
  return (
    <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <img className={'mx-auto h-36 w-auto fill-primary'} src={logo} alt="sd_logo" />
          {/* <svg
          ...
          <p className="mt-2 text-center text-sm text-gray-600">Введите данные для входа</p>
        </div>
